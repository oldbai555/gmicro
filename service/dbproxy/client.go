...
func GetModelList(ctx uctx.IUCtx, req *GetModelListReq) (*GetModelListRsp, error) {
	...
	err := rpc.DoRequest(ctx, ServerName, GetModelListCMDPath, http.MethodPost, req, &resp)
	if err != nil {
...
func InsertModel(ctx uctx.IUCtx, req *InsertModelReq) (*InsertModelRsp, error) {
	...
	err := rpc.DoRequest(ctx, ServerName, InsertModelCMDPath, http.MethodPost, req, &resp)
	if err != nil {
		return nil, gerr.Wrap(err)
	}
	return &resp, nil
...
func DelModel(ctx uctx.IUCtx, req *DelModelReq) (*DelModelRsp, error) {
	...
	err := rpc.DoRequest(ctx, ServerName, DelModelCMDPath, http.MethodPost, req, &resp)
	if err != nil {
		return nil, gerr.Wrap(err)
	}
	return &resp, nil
...
func UpdateModel(ctx uctx.IUCtx, req *UpdateModelReq) (*UpdateModelRsp, error) {
	...
	err := rpc.DoRequest(ctx, ServerName, UpdateModelCMDPath, http.MethodPost, req, &resp)
	if err != nil {
		return nil, gerr.Wrap(err)
	}
	return &resp, nil
...
func BatchInsertModel(ctx uctx.IUCtx, req *BatchInsertModelReq) (*BatchInsertModelRsp, error) {
	...
	err := rpc.DoRequest(ctx, ServerName, BatchInsertModelCMDPath, http.MethodPost, req, &resp)
	if err != nil {
		return nil, gerr.Wrap(err)
	}
	return &resp, nil
...
func SetModel(ctx uctx.IUCtx, req *SetModelReq) (*SetModelRsp, error) {
	...
	err := rpc.DoRequest(ctx, ServerName, SetModelCMDPath, http.MethodPost, req, &resp)
	if err != nil {
		return nil, gerr.Wrap(err)
	}
	return &resp, nil
